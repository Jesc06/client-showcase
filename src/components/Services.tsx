...
export const Services = () => {
  return (
    <section id="services" className="py-20 md:py-28 bg-gradient-to-b from-gray-50/80 via-white to-gray-50/80 dark:from-[#0a0a14] dark:via-[#050508] dark:to-[#0a0a14] relative">
      {/* Background Pattern */}
